    ...
    public class MappingConfiguration
    {
        public static void Configure()
        {
            Mapper.CreateMap<WorkItem, BaseEntity>()
                ...
                .ForMember(entity => entity.AttachedFileCount, option => option.MapFrom(workitem => workitem.Fields.SystemAttachedFileCount))
                .ForMember(entity => entity.AuthorizedAs, option => option.MapFrom(workitem => workitem.Fields.SystemAuthorizedAs))
                .ForMember(entity => entity.AuthorizedDate, option => option.MapFrom(workitem => workitem.Fields.SystemAuthorizedDate))
                ...
                .ForMember(entity => entity.ExternalLinkCount, option => option.MapFrom(workitem => workitem.Fields.SystemExternalLinkCount))
                ...
                .ForMember(entity => entity.IntegrationBuild, option => option.MapFrom(workitem => workitem.Fields.VstsIntegrationBuild))
                .ForMember(entity => entity.IterationId, option => option.MapFrom(workitem => workitem.Fields.SystemIterationId))
                .ForMember(entity => entity.IterationPath, option => option.MapFrom(workitem => workitem.Fields.SystemIterationPath))
                ...
                .ForMember(entity => entity.RelatedLinkCount, option => option.MapFrom(workitem => workitem.Fields.SystemRelatedLinkCount))
                ...
                .ForMember(entity => entity.StateChangeDate, option => option.MapFrom(workitem => workitem.Fields.VstsStateChangeDate))
                ...
                .AfterMap((workItem, entity) => entity.WorkItemType = WorkItemTypesExtensions.ConvertToEnum(workItem.Fields.SystemWorkItemType));
